...
public class entrykomponendok extends javax.swing.JFrame {
private Connection conn;
    private ResultSet rsl;
    private Statement stm;
    private String[] header={"ID_PESERTA","ID_KOMPONEN","NIP_PESERTA","KELENGKAPAN"};
    private Object[][] data=null;
    private String id,nama,bobot;
    public entrykomponendok() {
        initComponents();
        konnek();
        bacadt();
        isicombo1();
    ...
    jComboBox1.addActionListener(new ActionListener() {
          ...
          while(rsl.next()) {
              ...
              jTextField1.setText(rsl.getString("NIP_PESERTA"));
              }
    ...
    public void bacadt() {
        try {
          stm=conn.createStatement();
          rsl=stm.executeQuery("SELECT * FROM dokumen");
          ResultSetMetaData meta=rsl.getMetaData();
          ...
          while(rsl.next()) {
              ...
              data[x][3]=rsl.getString("KELENGKAPAN");
              x++;
          }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("KELENGKAPAN DOKUMEN");

        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lengkap", "Kurang Lengkap", "Tidak Lengkap", "Tidak Ada" }));
        ...
        jLabel1.setText("DATA KOMPONEN DOKUMEN");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(bacground11, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        ...
        setSize(new java.awt.Dimension(642, 625));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     bobot=jTextField1.getText();
     try{
         stm=conn.createStatement();
         stm.executeUpdate("INSERT INTO dokumen VALUES('"+id+"','"+nama+"','"+bobot+"','"+(String)jComboBox4.getSelectedItem()+"')");
         bacadt();
         kosong();
         aktif(false);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new entrykomponendok().setVisible(true);
            }
        });
    }   
